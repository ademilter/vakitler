      ...
      <div className="grid gap-4">
        ...
        <Box className="flex items-center gap-px p-2">
          <SettingsItem
            ...
            checked={timeFormat === TimeFormat.Twelve}
          ...
          <SettingsItem
            ...
            checked={timeFormat === TimeFormat.TwentyFour}
            isSelected={timeFormat === TimeFormat.TwentyFour}
            onChange={onChangeTimeFormat}
          >
        ...
        <Box>
          <Link
            ...
            className="flex h-12 cursor-pointer items-center gap-px px-4"
          >
        ...
        <div className="space-y-px">
          <Box helperClass="rounded-b-none">
            <a
              href="https://github.com/ademilter/vakitler"
              target="_blank"
              className="flex items-center rounded-t-lg p-4"
            >
              <div className="grow">
          ...
          <Box helperClass="rounded-t-none">
            <a
